...
网络结构如下图所示：
<center class="half">
    <img src="../downloads/pa/3.png", width=300, height=300>
    <img src="../downloads/pa/4.png", width=300, height=300>
</center>

作图为针对EAST的改进，即Pixel-based方法；右图为anchor-based的方法，主要针对长行的场景。
